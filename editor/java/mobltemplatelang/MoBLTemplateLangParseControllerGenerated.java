...
public class MoBLTemplateLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("MoBLTemplateLang");
  ...
  { 
    MoBLTemplateLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MoBLTemplateLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MoBLTemplateLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MoBLTemplateLangParseControllerGenerated.class);
    }
  ...
  { 
    return MoBLTemplateLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
